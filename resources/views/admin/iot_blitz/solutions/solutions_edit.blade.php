                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="row">
                            <div class="col-sm-9">
                                <div class="card-body">
                                    <form method="POST" action="{{ route('super_admin.page.solutions_edit', $solution_id) }}"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <input type="hidden" name="old_image" value="{{$solution->solutions_image}}" >
                                        <input type="hidden" name="old_pdf" value="{{$solution->solutions_brochure}}">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label class="floating-label" for="title">Title address</label>
                                                    <input type="title" class="form-control" id="title"
                                                        aria-describedby="titleHelp" name="title" value="{{$solution->solutions_title}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <input type="file" class="custom-file-input" id="validatedCustomFile"
                                                        name="productSolutionImage"  accept="image/*">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <input type="file" class="custom-file-input"
                                                        id="validatedCustomPdfFile" name="brochure_file"
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="inputWithBadges"
                                                        placeholder="" name="keyword" value="{{$solution->solutions_keywords}}">
                                                    <div id="badgeContainer"></div>
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <textarea name="description_editor" placeholder="description" class="form-control" rows="12" cols="50">{!! $solution->solutions_description !!}</textarea>
                                            </div>
                                            <input type="hidden" id="editorValue" name="text_description" value="{{$solution->text_description}}">
                                            <div class="col-sm-12">
                            ...
                            <div class="col-sm-3">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 mb-2">
                                        <div class="img">
                                            <img id="previewImage" src="{{ asset('public/solution_image') }}/{{$solution->solutions_image}}" class="img-fluid" alt="Preview Image"
                                                width="500%">
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="img">
                                            <iframe id="previewPdf" width="100%" height="400" src="{{ asset('public/solution_file_pdf') }}/{{$solution->solutions_brochure}}"></iframe>
                                        </div>
                                    </div>
                                </div>
