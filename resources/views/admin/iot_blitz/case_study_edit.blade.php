            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('super_admin.page.case_study') }}">Case Study</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('super_admin.page.case_study_edit', $case_study_id) }}"
                                ...
                                <div class="row">
                                    <div class="col-sm-5">
                                        <div class="form-group">
                                            ...
                                            <input type="title" class="form-control" id="title"
                                                ...
                                                value="{{ $editdata->case_study_title }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <input type="hidden" value="{{ $editdata->case_study_image }}" name="old_image">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="img">
                                            <img id="previewImage"
                                                src="{{ asset('case_study_images') }}/{{ $editdata->case_study_image }}"
