...
@section('admin_page_content')
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
           ...
           {{-- {{ auth()->user()->user_info}} --}}
           <form method="POST" id="myForm" action="{{ route('super_admin.page.products_edit', $product_id) }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-sm-9">
                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control required-field" id="title" aria-describedby="titleHelp" name="title" value="{{ $editdata->product_title }}" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <textarea name="description_editor" placeholder="description" class="form-control required-field description_editor" rows="12" cols="50">{!! $editdata->product_description !!}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="inputWithBadges" placeholder="" name="keyword" value="{{ $editdata->keyword }}" required>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="col-sm-12 mb-3 mt-2">
                                        @if(!empty($editdata->product_image) ||  $editdata->product_image==null)
                                        ...
                                        @else
                                        <img id="previewImage" src="{{ asset('public/product_image') }}/{{ $editdata->product_image }}" class="img-fluid" alt="Preview Image">
                                        @endif
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <input type="hidden" value="{{ $editdata->product_imag }}" name="old_image">
                                            <input type="file" class="custom-file-input required-field" id="validatedCustomFile" name="productImage">
