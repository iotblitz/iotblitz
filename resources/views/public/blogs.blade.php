            ...
            <h2>Upcoming Case Study</h2>
                ...
                @foreach ($blogs as $blogdata)
                    <div class="col-lg-12 col-md-6">
                        <div class="item"
                            onclick="location.href = '{{ route('single_blogs', [preg_replace('/[^a-z0-9]+/', '-', strtolower(trim($blogdata->blog_title))) . '-' . $blogdata->blog_id]) }}';">
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="image">
                                ...
                                <a href="{{ route('single_blogs', [preg_replace('/[^a-z0-9]+/', '-', strtolower(trim($blogdata->blog_title))) . '-' . $blogdata->blog_id]) }}"><i
                ...
                <div class="col-md-3 mt-5">
                    ...
                    <div class="sidebar-widget latest-post card border-0 p-4 mb-3">
                        ...
                        <div class="d-flex flex-wrap justify-content-between">
                            ...
                            <a href="{{route('public_blog_tags', ['tags' => preg_replace('/[^a-z0-9]+/', '-',strtolower(trim($tagdata->tag_count)))])}}" class="text-decoration-none mb-2">
