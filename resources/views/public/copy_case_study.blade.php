        ...
        {{-- <div class="col-lg-12 text-center">
          <div class="section-heading">
            ...
            @foreach ($case_study as $case_study_data)
                <div class="col-lg-12 col-md-6" onclick="location.href = '{{ route('single_case_study', [preg_replace('/[^a-z0-9]+/', '-', $case_study_data->case_study_title).'-'.$case_study_data->case_study_id])}}';">
                    <div class="item">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="image">
                            ...
                            <a href="{{ route('single_case_study', [preg_replace('/[^a-z0-9]+/', '-', $case_study_data->case_study_title).'-'.$case_study_data->case_study_id])}}"><i class="fa fa-angle-right"></i></a>
