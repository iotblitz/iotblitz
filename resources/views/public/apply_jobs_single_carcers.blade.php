                ...
                <div class="col-lg-12">
                    <div class="header-text text-center">
                        ...
                        <ul class="list-inline">
                            ...
                            <li class="list-inline-item"><span class="text-white">/</span></li>
                            <li class="list-inline-item"><a href="{{ route('single_careers', [preg_replace('/[^a-z0-9]+/', '-', strtolower(trim($product->title))) . '-' . $product->careers_id]) }}" class="text-white-50">{{ ucwords($product->title) }}</a></li>
                            <li class="list-inline-item"><span class="text-white">/</span></li>
