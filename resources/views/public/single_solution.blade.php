                ...
                <div class="sidebar-widget latest-post card border-0 p-4 mb-3">
                    ...
                    @foreach ($solution as $solutions_key)
                        <div class="media border-bottom py-3" style="display: flex;  align-items: flex-start;">
                            <a
                                href="{{ route('single_solutions', [preg_replace('/[^a-z0-9]+/', '-', $solutions_key->solutions_title) . '-' . $solutions_key->solutions_id]) }}">
                            ...
                            <div class="media-body" style=" flex: 1;">
                                <h6 class="my-1">
                                    <a href="{{ route('single_solutions', [preg_replace('/[^a-z0-9]+/', '-', $solutions_key->solutions_title) . '-' . $solutions_key->solutions_id]) }}"
