            ...
            <div class="row align-items-center">
                <div class="col-lg-7">
                    <div class="header-text  mt-5">
                        ...
                        <p class="text-white">Explore IoTBlitz LLP's AI, IoT, and Design expertise. Transform processes, enhance efficiency, and drive innovation with our tailored technology solutions.</p>
            ...
            <h2>Upcoming Case Study</h2>
                ...
                @foreach ($case_study as $case_study_data)
                    <div class="col-lg-12 col-md-6">
                        <div class="item"
                            onclick="location.href = '{{ route('single_case_study', [preg_replace('/[^a-z0-9]+/', '-', $case_study_data->case_study_title) . '-' . $case_study_data->case_study_id]) }}';">
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="image">
                                ...
                                <a
                                    href="{{ route('single_case_study', [preg_replace('/[^a-z0-9]+/', '-', $case_study_data->case_study_title) . '-' . $case_study_data->case_study_id]) }}"><i
