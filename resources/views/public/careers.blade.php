            ...
            @foreach ($careers as $careers_data)
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div>
                                ...
                                <button class="btn btn-light shareButton" id="shareButton"
                                    ...
                                    joburl="{{ route('single_careers', [preg_replace('/[^a-z0-9]+/', '-', strtolower($careers_data->title)) . '-' . $careers_data->careers_id]) }}"
                        ...
                        <br>
                        <a href="{{ route('single_careers', [preg_replace('/[^a-z0-9]+/', '-', strtolower($careers_data->title)) . '-' . $careers_data->careers_id]) }}"
