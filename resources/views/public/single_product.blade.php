                ...
                <div class="sidebar-widget latest-post card border-0 p-4 mb-3">
                    ...
                    @foreach ($cattagorydata->products as $product_key)
                        <div class="media border-bottom py-3" style="display: flex;  align-items: flex-start;">
                            <a href="{{ route('single_product', [preg_replace('/[^a-z0-9]+/', '-', strtolower($product_key->product_title)) . '-' . $product_key->product_id]) }}"><img class="mr-4"
                            ...
                            <div class="media-body" style=" flex: 1;">
                                <h6 class="my-1"><a href="{{ route('single_product', [preg_replace('/[^a-z0-9]+/', '-', strtolower($product_key->product_title)) . '-' . $product_key->product_id]) }}" class="text-body">{{ $product_key->product_title }}</a>
                                </h6>
                                <p class="my-1"><a href="{{ route('single_product', [preg_replace('/[^a-z0-9]+/', '-', strtolower($product_key->product_title)) . '-' . $product_key->product_id]) }}" class="text-body text-justify">{{ substr($product_key->text_description, 0, 37) }}...</a>
                                </p>
