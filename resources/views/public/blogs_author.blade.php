            ...
            <h2>Upcoming Case Study</h2>
                ...
                @foreach ($blogs as $blogdata)
                    <div class="col-lg-12 col-md-6">
                        <div class="item"
                            onclick="location.href = '{{ route('single_blogs', [preg_replace('/[^a-z0-9]+/', '-', strtolower($blogdata->blog_title)) . '-' . $blogdata->blog_id]) }}';">
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="image">
                                ...
                                <a href="{{ route('single_blogs', [preg_replace('/[^a-z0-9]+/', '-', strtolower($blogdata->blog_title)) . '-' . $blogdata->blog_id]) }}"><i
