...
class PublicBlogModel extends Model
{
    ...
    protected $fillable = [
        "blog_title", "blog_keywords", "blog_description", "text_description", "blog_image", "featured_image_alt_text", "image_description", "image_caption", "image_title", "meta_title", "meta_descriptions", "focus_keyword", "blog_excerpt","content_category", "active_status", "create_by"
    ];
